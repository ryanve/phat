...
if ( ! function_exists('wp_attr_encode')) {
...
if ( ! function_exists('wp_attr_decode')) {
...
if ( ! function_exists('wp_attr_tokens')) {
    /**
     * @param   string  $tagname
     * @param   mixed   $attr
     * @param   mixed   $inner
...
if ( ! function_exists('wp_attr_parse')) {
    /**
